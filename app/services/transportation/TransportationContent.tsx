    ...
    <>
      ...
      <section ref={heroRef} className="relative pt-32 pb-20 overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="/Logistics-20251119T135955Z-1-001/Cargo-Logistics/venti-views-FPKnAO-CF6M-unsplash.webp"
      ...
      <Section className="relative overflow-hidden gradient-mesh">
        ...
        <div
          className="absolute bottom-20 -right-20 w-80 h-80 bg-primary-navy/10 rounded-full blur-3xl animate-float"
      ...
      {/* CTA Section */}
      <Section className="bg-gradient-to-br from-primary-navy via-[#0E287A] to-primary-navy text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <Link href="/contact">
            <Button
              size="lg"
              className="bg-white text-primary-navy hover:bg-gray-100 font-semibold shadow-xl hover:shadow-2xl transition-all duration-300"
            >
              Contact Us
            </Button>
          </Link>
