...
import EquipmentHireCarousel from "@/components/services/EquipmentHireCarousel";
...
export default function EquipmentHireContent() {
  ...
  return (
    <>
      ...
      <Section className="relative overflow-hidden bg-[#F2F4F7]">
        ...
        <div ref={carouselRef} className="carousel-section relative z-10 max-w-7xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0A0A0A] mb-4">
              Equipment for Hire
            </h2>
            <p className="text-lg text-[#4B5563] max-w-3xl mx-auto">
              Efficient Equipment Hire Solutions for Seamless Operations and Flexible Resource Management
            </p>
          </div>
          <EquipmentHireCarousel />
        </div>
      </Section>
