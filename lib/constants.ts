...
export const SERVICES = [
  ...
  },
  {
    ...
    shortDescription: "Accurate handling of customs processes with full regulatory compliance and minimal dwell time.",
    description: "We handle customs procedures with precise documentation and regulatory accuracy to minimise clearance delays.",
    capabilities: [
  ...
  },
  {
    ...
    shortDescription: "End-to-end management of oversized and non-containerised cargo with engineered routing and safe lift planning.",
    description: "We plan and execute project cargo and heavy lifts with engineered routing, defined safety steps, and on-ground control.",
    capabilities: [
      "Break bulk handling",
      "Heavy-lift planning",
      "Site assessments",
